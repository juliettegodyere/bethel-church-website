         ...
         let sermonContent = `
            <div class="single-sermons col-md-6">
                <div class="sermons-content d-flex align-items-center">
                    ...
                    ${sermon.text_content ? `<div class="see-more-btn">
                        <a href="#" type="button" data-toggle="modal" data-id=${sermon.pastor_id} data-target=#${sermon.id} class='open-dialog'>See More</a>
                    </div>` : ""}
                </div>
            </div>
            
            <div id=${sermon.id}  class="modal fade right" ${m = sermon.id} tabindex="-1" role="dialog">
                <div class="modal-dialog-full-width modal-dialog momodel modal-fluid" role="document">
                    <div class="modal-content-full-width modal-content">
                        <div class="modal-header-full-width modal-header text-center">


                        <div class="mh-bg-img" style="background-image: url(${sermon.background_image});">
